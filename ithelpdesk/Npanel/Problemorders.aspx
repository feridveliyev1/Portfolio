<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Npanel/MasterPage.master" CodeFile="Problemorders.aspx.cs" Inherits="Npanel_Problemorders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <!-- Page-Title -->
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Problem Order</h4>
								<ol class="breadcrumb">
									<li>
										<a href="#">Orders</a>
									</li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                       <ContentTemplate>
                                    <asp:SqlDataSource ID="problem_order_sql" runat="server"></asp:SqlDataSource>
                                    <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="ObjectsGrid" runat="server" DataSourceID="problem_order_sql" >
                                                   <ItemTemplate>
                                                      <tr>
                                                         <td><%# Eval("ID") %></td>
                                                         <td><%# Eval("DATE") %></td>
