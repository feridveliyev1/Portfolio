<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="Doneorders.aspx.cs" Inherits="Npanel_Doneorders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <!-- Page-Title -->
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Done Order </h4>
								<ol class="breadcrumb">
									<li>
										<a href="#">Orders</a>
									</li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                       <ContentTemplate>
                                    <asp:SqlDataSource ID="ready_order_sql" runat="server"></asp:SqlDataSource>
                                    <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="ObjectsGrid" runat="server" DataSourceID="ready_order_sql" >
                                                   <ItemTemplate>
                                                      <tr>
                                                         <td><%# Eval("ID") %></td>
                                                         <td><%# Eval("DATE") %></td>
                                                         <td><%# Eval("TEAMVIEWER") %></td>
                                                         <td><%# Eval("USER_FIO") %></td>
                                                          <td align="center">
                                            ...
                                            <div class="modal-content"> 
                                                    ...
                                                    <div class="row"> 
                                                     ...
                                                     <div class="col-sm-12">
                                                           ...
                                                           <div class="col-sm-4">
                                                            ...
                                                            <asp:DropDownList runat="server" ID="order_status_ddl" class="form-control" DataSourceID="order_type_sql" DataTextField="NAME" DataValueField="ID"> </asp:DropDownList>
                                                          ...
                                                          <%-- <asp:RadioButtonList ID="order_type_rdb" runat="server" Visible="false" DataValueField="ID" DataTextField="NAME" DataSourceID="order_type_sql"></asp:RadioButtonList>--%>
                                                             ...
                                                             <div class="col-sm-12"  runat="server" id="problem_div" >
                                                            <label for="field-3" class="control-label">Description for problem :</label>
                                                           <asp:TextBox runat="server" ID="problem_txt"   CssClass="form-control" TextMode="MultiLine" Rows="3" Enabled="false"> </asp:TextBox>
                                                ...
                                                <div class="modal-footer"> 
                                                    ...
                                                    <asp:Button ID="Save_btn" runat="server" 
                                                        ...
                                                        ValidationGroup="OBJECT_ADD_EDIT" Text="Saxla" Visible="false" OnClick="Save_btn_click"  OnClientClick="this.disabled='true'; this.value='Please wait...';" UseSubmitBehavior="false"/>
                                                </div>
                                                </div>
                                            </div> 
                                        </div>
