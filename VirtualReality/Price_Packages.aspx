<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Price_Packages.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="defaultinner" %>
                                                ...
                                                <asp:Repeater ID="ObjectsGrid" runat="server" DataSourceID="SqlDataSource1" OnItemCommand="ObjectsGrid_ItemCommand" OnItemDataBound="ObjectsGrid_ItemDataBound">
                                                   <ItemTemplate>
                                                      <tr>
                                                         ...
                                                         <td><%# Eval("CATEGORY")%></td>
                                                         <td><%# Eval("PRICE")%></td>
                                                         <td><%# Eval("DURATION_IN_MINUTES")%></td>
                                                         <td align="center">
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <label for="field-3" class="control-label">Aparatların kategoriyası</label> 
                                                                <asp:UpdatePanel ID="updatepanel3" runat="server">
                                                                <ContentTemplate>
                                                                <asp:DropDownList ID="device_dll" runat="server" CssClass="form-control" DataTextField="NAME" DataValueField="ID"></asp:DropDownList>
                                                                </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                                <label for="field-3" class="control-label">Qiymət</label> 
                                                                <asp:TextBox ID="Price_edt" runat="server" CssClass="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="Price_edt" Display="Dynamic" ValidationGroup="OBJECT_ADD_EDIT"></asp:RequiredFieldValidator>
                                                                <label for="field-3" class="control-label">Müddəti</label> 
                                                                <asp:TextBox ID="Minute_edt" runat="server" CssClass="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="Minute_edt" Display="Dynamic" ValidationGroup="OBJECT_ADD_EDIT"></asp:RequiredFieldValidator>
                                                            </div> 
                                                        </div> 
                                                    </div> 
