<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Devices.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="Devices" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <!-- Page-Title -->
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Aparatlar</h4>
								<ol class="breadcrumb">
									<li>
										<a href="#">Aparatlar</a>
									</li>
                                                ...
                                                <asp:Repeater ID="ObjectsGrid" runat="server" DataSourceID="SqlDataSource1" OnItemCommand="ObjectsGrid_ItemCommand" OnItemDataBound="ObjectsGrid_ItemDataBound">
                                                   <ItemTemplate>
                                                      <tr>
                                                         ...
                                                         <td align="center">
                                                             <asp:LinkButton ID="Delete_btn" runat="server" CssClass="table-action-btn" CommandArgument='<%# Eval("ID") %>' CommandName="DELETE_DEVICE"><i class="md md-delete"></i></asp:LinkButton>
                                                         </td>
                                                      </tr>
                                                   </ItemTemplate>
                                                </asp:Repeater>
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <asp:TextBox ID="device_name_edt" runat="server" CssClass="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="device_name_edt" Display="Dynamic" ValidationGroup="OBJECT_ADD_EDIT"></asp:RequiredFieldValidator>
                                                           <label for="field-3"  id="device_category_lb" runat="server" class="control-label">Kateqoriya</label> 
                                                           <asp:SqlDataSource id="device_category_sql" runat ="server"></asp:SqlDataSource>
                                                           <asp:DropDownList  ID="device_category_ddl" runat="server" DataSourceID="device_category_sql" DataValueField="ID" DataTextField="NAME" CssClass="required form-control"></asp:DropDownList>
                                                            </div> 
                                                        </div> 
                                                    </div> 
