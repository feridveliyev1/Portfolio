<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GamesCategory.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="defaultinner" %>
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Oyunların kategoriyası</label> 
                                                                <asp:TextBox ID="Games_edt" runat="server" CssClass="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="Games_edt" Display="Dynamic" ValidationGroup="OBJECT_ADD_EDIT"></asp:RequiredFieldValidator>
                                                            </div> 
                                                        </div> 
                                                    </div> 
