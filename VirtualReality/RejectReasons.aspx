<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RejectReasons.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="defaultinner" %>
                                                    ...
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <asp:TextBox ID="Reject_edt" runat="server" CssClass="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="Reject_edt" Display="Dynamic" ValidationGroup="OBJECT_ADD_EDIT"></asp:RequiredFieldValidator>
                                                            </div> 
                                                        </div> 
                                                    </div> 
