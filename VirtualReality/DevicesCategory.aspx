<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevicesCategory.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="defaultinner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <!-- Page-Title -->
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Словари</h4>
								<ol class="breadcrumb">
									<li>
										<a href="#">Словари</a>
									</li>
                                            ...
                                            <div class="modal-content"> 
                                                <div class="modal-header"> 
                                                    ...
                                                    <h4 class="modal-title">
                                                        <asp:Literal ID="ModalCaption_lb" runat="server">Добавление</asp:Literal></h4> 
                                                </div> 
                                                <div class="modal-body"> 
                                                    <div class="row"> 
                                                        <div class="col-md-12"> 
                                                            <div class="form-group"> 
                                                                <label for="field-3" class="control-label">Название</label> 
                                                                <asp:TextBox ID="Devices_edt" runat="server" CssClass="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="Devices_edt" Display="Dynamic" ValidationGroup="OBJECT_ADD_EDIT"></asp:RequiredFieldValidator>
                                                            </div> 
                                                        </div> 
                                                    </div> 
                                                ...
                                                <div class="modal-footer"> 
                                                    ...
                                                    <asp:LinkButton ID="Save_btn" runat="server" 
                                                        ...
                                                        ValidationGroup="OBJECT_ADD_EDIT" onclick="Save_btn_Click">Сохранить</asp:LinkButton>
                                                </div> 
                                            </div> 
                                        </div>
                                           </ContentTemplate>
